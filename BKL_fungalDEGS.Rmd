...
```{r}
topTags(trt.lrt) # the top 10 most differentially expressed genes between the two treatments (using the above model)
```

```{r}
topTags(sp.lrt) # the top 10 most differentially expressed genes between the two species (using the above model)
```

...
Normalization in edgeR/voom is model-based, you calculate normalization
factors using the function calcNormFactors which by default uses TMM
(trimmed means of M values). Assumes most genes are not DE.

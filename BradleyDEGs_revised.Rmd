...
new_gene_names <- c("PSME_21469: CYP71", "PSME_27306: auxin signaling", "PSME_31667: sugar metabolism; stress/defense", "PSME_38503: CRK", "PSME_30375: TIR-NLR-like", "PSME_29048: unkown", "PSME_51370: sugar metabolism; stress", "PSME_27294: specialized metabolism", "PSME_23020: unknown", "PSME_37466: bHLH", "PSME_13638: DCN1", "PSME_42174: RdRP", "PSME_19388: glycogen + 2ary metabolism; stress", "PSME_51302: USP", "PSME_06003: MKS1-like", "PSME_12596: cell signaling; metabolism; stress", "PSME_16206: antibiotic synthesis", "PSME_47136: GH16 XET cell wall mod", "PSME_12910: pectin cell wall mod", "PSME_04115: stress/defense", "PSME_04789: cell signaling; post-translational mod", "PSME_31428: aa + 2ary metabolism", "PSME_11752: sugar transporter", "PSME_08506: protein-protein", "PSME_39647: cell signaling", "PSME_48863: sugar transporter", "PSME_40178: BURP", "PSME_38415: USP", "PSME_40947: XTH")
...
# List all interpro files in your folder (adjust pattern or path as needed)
...
for (f in files) {
  ...
  # Name the list element by the file name (optional: without path and extension)
...
# Now summary_list contains one summarized dataframe per file
...
```{r}
write.csv(combined_df, "combined_summary.csv", row.names = FALSE)

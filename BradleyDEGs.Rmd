...
```{r}
summary(decideTestsDGE(trt.lrt.TC, p.value = 0.01))
summary(decideTestsDGE(sp.lrt.TC.ST, p.value=0.01))
summary(decideTestsDGE(sp.lrt.TC.TC, p.value=0.01))
summary(decideTestsDGE(lrt.interaction.TC, p.value=0.01))
summary(decideTestsDGE(lrt.interaction.TC2, p.value=0.01))
```
